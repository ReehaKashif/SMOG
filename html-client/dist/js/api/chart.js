...
const plotSmogCausesChart = (data) => {
    ...
    console.log("Date Range:", dateRange.map(date => date.toISOString().split('T')[0]));
    ...
    const lastMonthData = dateRange.map((date) => {
        ...
        const index = last_month_dates.indexOf(formattedDate);
        console.log(`Checking date: ${formattedDate}, Found Index: ${index}`);
