...
const plotSmogCausesChart = (data) => {
    ...
    // Force-render last 7 days data with a constant value (e.g., 50) for testing purposes
    const last7DaysCombinedData = Array(7).fill(50);
    ...
    const datasets = [
        ...
        {
            label: "Last 7 days",
            data: last7DaysCombinedData, // Forced constant data for testing
