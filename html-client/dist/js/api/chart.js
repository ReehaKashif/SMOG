  ...
  const datasets = [
    ...
    },
    {
      ...
      borderColor: (context) => {
        ...
        const diffInDays = (date - currentDate) / (1000 * 60 * 60 * 24);

        if (diffInDays <= 7 && diffInDays > 0) return '#8B0000'; // Next 7 days
        if (diffInDays <= 14 && diffInDays > 7) return '#ff0000'; // Next 14 days
        return diffInDays > 14 ? '#FF7F7F' : '#000000'; // Beyond 14 days
      },
      fill: false,
      pointStyle: false,
      tension: 0.1,
