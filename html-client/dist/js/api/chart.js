...
const plotSmogCausesChart = (data) => {
    ...
    const last_month_dates = data["last_month_data"]["dates"];
    const last_month_aqi = data["last_month_data"]["aqi"];
    ...
    console.log("Final Last Month Combined Data:", lastMonthCombinedData);
            ...
            segment: {
                borderColor: function(context) {
                    ...
                    if (diffInDays <= 7 && diffInDays > 0) {
                        ...
                        return '#ff0000'; // Default Black for past dates
                    }
                }
            },
            fill: false,
