                        ...
                        generateLabels: function(chart) {
                            ...
                            const customLabels = [
                                ...originalLabels.map(label => {
                                    if (label.text === "Previous Year") {
                                        label.fillStyle = "#808080";
                                        label.strokeStyle = "#808080";
                                    } else if (label.text === "Current Year") {
                                        label.fillStyle = "#000000";
                                        label.strokeStyle = "#000000";
                                    }
                                    return label; // Leave other original labels unchanged
                                }),
                                {
                                    text: "Next 7 Days",
                                    fillStyle: '#8B0000',
