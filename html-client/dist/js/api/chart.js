...
const plotSmogCausesChart = (data) => {
  ...
  // Collect the last 7 days of AQI data from current year's past two months
  for (let i = 0; i < 7; i++) {
      ...
      // Replace null with 50 for testing purposes
      last7DaysData.unshift(aqiValue !== null ? aqiValue : 50);
      last7DaysLabels.unshift(formattedPastDate);
  }

  // Prepare last 7 days data combined
  const last7DaysCombinedData = last7DaysData; // Directly use last7DaysData
  ...
  const datasets = [
      ...
      {
          label: "Last 7 days",
          data: last7DaysCombinedData, // The AQI data for the last 7 days
