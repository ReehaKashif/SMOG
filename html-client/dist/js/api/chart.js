...
const plotSmogCausesChart = (data) => {
    ...
    // Create adjusted line data starting from the Dark Red Line for the next 7 days
    ...
    const adjustedLineData = future7DaysData.map((value, index) => {
        const blackLineValue = last7DaysBlackLineData[index];
